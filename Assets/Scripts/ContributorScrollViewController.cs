...
public class ContributorScrollViewController : MonoBehaviour
{
    ...
    private void UpdateContributors(List<FiletreeManager.Contributer> contributors)
    {
    ...
    private UIControbutor InstantiateContributor(FiletreeManager.Contributer contributor, int i)
    {
